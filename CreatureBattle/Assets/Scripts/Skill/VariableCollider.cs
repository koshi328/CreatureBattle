...
public class VariableCollider : MonoBehaviour
{
    ...
    public VariableCollider EntrySphereCollider(int layerName, Actor owner, float limitTime, int damage, int damageRange, Vector3 center, float radius, StatusAilmentBase[] statusAilments)
    {
        Initialize();
        _type = COLLIDER_TYPE.SPHERE;
        _owner = owner;
    ...
    public VariableCollider EntryCapsuleCollider(int layerName, Actor owner, float limitTime, int damage, int damageRange, Vector3 center, int direction, float height, float radius, StatusAilmentBase[] statusAilments)
    {
        Initialize();
    ...
    public VariableCollider EntryFanCollider(int layerName, Actor owner, float limitTime, int damage, int damageRange, Vector3 center, float radius, Vector3 currentAngle, float angleRange, StatusAilmentBase[] statusAilments)
    {
        Initialize();
